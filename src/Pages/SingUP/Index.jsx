...
function SignUP() {
  ...
  const handleSignUp = () => {
    if (!email) {
      ...
      createUserWithEmailAndPassword(auth, email, password)
        ...
        .catch((err) => {
          console.log(
            `error from createUserWithEmailAndPassword function ${err}`
          );
        });
    }
  };
  ...
  return (
    <div>
      <div className="bg-mainBgColor flex items-center justify-between w-screen h-screen overflow-hidden">
